...
Download the binary for your platform from [Releases](https://github.com/rancherlabs/dep-fetch/releases), or:

```sh
go install github.com/rancherlabs/dep-fetch@latest
```
